  ...
  kmp_TaskFctPtr taskSub)
{
  ...
  omptarget_nvptx_ExplicitTaskDescr *newExplicitTaskDescr = (omptarget_nvptx_ExplicitTaskDescr *) 
  ...
  ASSERT0(LT_FUSSY, (uint64_t) newKmpTaskDescr == 
     (uint64_t) ADD_BYTES(newExplicitTaskDescr, sizeof(omptarget_nvptx_TaskDescr)),
  ...
  void * noAliasDepList)
{
  ...
  omptarget_nvptx_ExplicitTaskDescr *newExplicitTaskDescr = (omptarget_nvptx_ExplicitTaskDescr *) 
    SUB_BYTES(newKmpTaskDescr, sizeof(omptarget_nvptx_TaskDescr));
  ...
  omptarget_nvptx_threadPrivateContext.SetTopLevelTaskDescr(gtid, newTaskDescr);
